...
import { createDoctorProfile, getAllDoctors, getDoctorById, getDoctorSpecialization, setAvailability, updateDoctorProfile } from '../controllers/doctorController.js';
...
router.put('/updateProfile', authMiddleware, authorizeMiddleware, updateDoctorProfile); // Update availability
